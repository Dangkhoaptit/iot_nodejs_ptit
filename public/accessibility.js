...
*/
(function(a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/accessibility", ["highcharts"], function(t) {
        a(t);
        a.Highcharts = t;
        return a
    }) : a("undefined" !== typeof Highcharts ? Highcharts : void 0)
})(function(a) {
    function t(a, f, l, m) { a.hasOwnProperty(f) || (a[f] = m.apply(null, l)) }
    a = a ? a._modules : {};
    t(a, "modules/accessibility/utils/htmlUtilities.js", [a["parts/Utilities.js"], a["parts/Globals.js"]], function(a, f) {
        function q(a) {
            return a.replace(/&/g,
        ...
        var m = a.merge,
            ...
            e = p.document;
        return {
            addClass: function(a, g) { a.classList ? a.classList.add(g) : 0 > a.className.indexOf(g) && (a.className += g) },
            escapeStringForHTML: q,
            ...
            getFakeMouseEvent: function(a) {
                ...
                if (e.createEvent) {
                    var g = e.createEvent("MouseEvent");
            ...
            reverseChildNodes: function(a) { for (var g = a.childNodes.length; g--;) a.appendChild(a.childNodes[g]) },
            setElAttrs: function(a, g) {
                Object.keys(g).forEach(function(e) {
                    var c = g[e];
                    null === c ? a.removeAttribute(e) : (c = q("" + c), a.setAttribute(e, c))
                })
            },
    ...
    t(a, "modules/accessibility/utils/chartUtilities.js", [a["modules/accessibility/utils/htmlUtilities.js"], a["parts/Utilities.js"]], function(a, f) {
        function q(a) { if (a.points && a.points.length && a.points[0].graphic) return a.points[0].graphic.element }

        function m(a) {
            var g =
                q(a);
            return g && g.parentNode || a.graph && a.graph.element || a.group && a.group.element
        }

        function p(a, e) {
            e.setAttribute("aria-hidden", !1);
            e !== a.renderTo && e.parentNode && (Array.prototype.forEach.call(e.parentNode.childNodes, function(a) { a.hasAttribute("aria-hidden") || a.setAttribute("aria-hidden", !0) }), p(a, e.parentNode))
        }
        var e = a.stripHTMLTagsFromString,
            h = f.find;
        return {
            getChartTitle: function(a) { return e(a.options.title.text || a.langFormat("accessibility.defaultChartTitle", { chart: a })) },
            ...
            getPointFromXY: function(a, e, c) {
                for (var d = a.length, b; d--;)
                    if (b = h(a[d].points || [], function(b) { return b.x === e && b.y === c })) return b
            },
            getSeriesFirstPointElement: q,
            getSeriesFromName: function(a, e) { return e ? (a.series || []).filter(function(a) { return a.name === e }) : a.series },
    ...
    t(a, "modules/accessibility/KeyboardNavigationHandler.js", [a["parts/Utilities.js"]], function(a) {
        function q(a, q) {
            this.chart = a;
            this.keyCodeMap = q.keyCodeMap || [];
            this.validate = q.validate;
            this.init = q.init;
            this.terminate = q.terminate;
            this.response = { success: 1, prev: 2, next: 3, noHandler: 4, fail: 5 }
        }
        var l = a.find;
        q.prototype = {
            run: function(a) {
                var q = a.which || a.keyCode,
                    e = this.response.noHandler,
                    h = l(this.keyCodeMap, function(a) { return -1 < a[0].indexOf(q) });
                h ? e = h[1].call(this, q, a) : 9 === q && (e = this.response[a.shiftKey ? "prev" : "next"]);
                return e
            }
        };
        return q
    });
    t(a, "modules/accessibility/utils/EventProvider.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function(a, f) {
        var q = f.addEvent;
        f = f.extend;
        var m = function() { this.eventRemovers = [] };
        f(m.prototype, {
            addEvent: function() {
                var f = q.apply(a, arguments);
                this.eventRemovers.push(f);
                return f
            },
            removeAddedEvents: function() {
                this.eventRemovers.forEach(function(a) { a() });
                this.eventRemovers = []
            }
        });
        return m
    });
    t(a, "modules/accessibility/utils/DOMElementProvider.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function(a, f, l) {
        var q = a.win.document;
        a = f.extend;
        var p = l.removeElement;
        l = function() { this.elements = [] };
        a(l.prototype, {
            createElement: function() {
                var a = q.createElement.apply(q, arguments);
    ...
    t(a, "modules/accessibility/AccessibilityComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"],
        a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/EventProvider.js"], a["modules/accessibility/utils/DOMElementProvider.js"]
        ...
        h.prototype = {
            ...
            fireEventOnWrappedOrUnwrappedElement: function(b, a) {
                var d = a.type;
                n.createEvent && (b.dispatchEvent || b.fireEvent) ? b.dispatchEvent ? b.dispatchEvent(a) : b.fireEvent(d, a) : c(b, d, a)
            },
            fakeClickEvent: function(b) {
                if (b) {
                    var a = r("click");
                    this.fireEventOnWrappedOrUnwrappedElement(b,
                        a)
                }
            },
            addProxyGroup: function(b) {
                ...
                Object.keys(b || {}).forEach(function(d) { null !== b[d] && a.setAttribute(d, b[d]) });
                this.chart.a11yProxyContainer.appendChild(a);
                return a
            },
            createOrUpdateProxyContainer: function() {
                ...
                a.nextSibling !== b.a11yProxyContainer && b.container.insertBefore(b.a11yProxyContainer, a.nextSibling)
            },
            ...
            createProxyButton: function(b, a, r, c, e) {
                var x = b.element,
                    v = this.createElement("button"),
                    u = d({ "aria-label": x.getAttribute("aria-label") }, r);
                b = this.getElementPosition(c || b);
                Object.keys(u).forEach(function(b) { null !== u[b] && v.setAttribute(b, u[b]) });
                v.className = "highcharts-a11y-proxy-button";
                e && this.addEvent(v, "click", e);
                this.setProxyButtonStyle(v, b);
                this.proxyMouseEventsForButton(x, v);
                a.appendChild(v);
                u["aria-hidden"] || k(this.chart,
                    v);
                return v
            },
            getElementPosition: function(b) { var a = b.element; return (b = this.chart.renderTo) && a && a.getBoundingClientRect ? (a = a.getBoundingClientRect(), b = b.getBoundingClientRect(), { x: a.left - b.left, y: a.top - b.top, width: a.right - a.left, height: a.bottom - a.top }) : { x: 0, y: 0, width: 1, height: 1 } },
            ...
            proxyMouseEventsForButton: function(b, a) {
                var d = this;
                "click touchstart touchend touchcancel touchmove mouseover mouseenter mouseleave mouseout".split(" ").forEach(function(r) {
                    d.addEvent(a, r, function(a) {
                        var r = d.cloneMouseEvent(a);
                        b && d.fireEventOnWrappedOrUnwrappedElement(b, r);
                        a.stopPropagation();
                        a.preventDefault()
                    })
                })
            ...
            cloneMouseEvent: function(b) {
                if ("function" ===
                    typeof g.MouseEvent) return new g.MouseEvent(b.type, b);
                if (n.createEvent) { var a = n.createEvent("MouseEvent"); if (a.initMouseEvent) return a.initMouseEvent(b.type, b.bubbles, b.cancelable, b.view || g, b.detail, b.screenX, b.screenY, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, b.button, b.relatedTarget), a }
                return r(b.type)
            },
    ...
    t(a, "modules/accessibility/KeyboardNavigation.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/EventProvider.js"]], function(a, f, l, m) {
        function q(a, b) { this.init(a, b) }
        var e = a.win,
            h = e.document,
            g = f.addEvent,
            n = f.fireEvent,
            c = l.getElement;
        g(h, "keydown", function(d) {
        ...
        q.prototype = {
            init: function(a, b) {
                var d = this,
                    k = this.eventProvider = new m;
                this.chart = a;
                this.components = b;
                this.modules = [];
                this.currentModuleIx = 0;
                k.addEvent(a.renderTo, "keydown", function(b) { return d.onKeydown(b) });
                k.addEvent(a.container, "focus", function(b) { return d.onFocus(b) });
                k.addEvent(h, "mouseup",
                    function() { return d.onMouseUp() });
                k.addEvent(a.renderTo, "mouseover", function() { d.pointerIsOverChart = !0 });
                k.addEvent(a.renderTo, "mouseout", function() { d.pointerIsOverChart = !1 });
                this.update();
            ...
            update: function(a) {
                ...
                b && b.enabled && a && a.length ? (this.modules = a.reduce(function(b, a) { a = d[a].getKeyboardNavigation(); return b.concat(a) }, []), this.updateExitAnchor()) :
                    (this.modules = [], this.currentModuleIx = 0, this.removeExitAnchor())
            },
            onFocus: function(a) {
                var b, d = this.chart;
                a.relatedTarget && d.container.contains(a.relatedTarget) || (null === (b = this.modules[0]) || void 0 === b ? void 0 : b.init(1))
            },
            onMouseUp: function() {
            ...
            onKeydown: function(a) {
                a =
                    a || e.event;
                var b, d = this.modules && this.modules.length && this.modules[this.currentModuleIx];
                this.keyboardReset = !1;
                if (d) {
                    var k = d.run(a);
                    k === d.response.success ? b = !0 : k === d.response.prev ? b = this.prev() : k === d.response.next && (b = this.next());
            ...
            move: function(a) {
                ...
                if (b = this.modules && this.modules[this.currentModuleIx]) { if (b.validate && !b.validate()) return this.move(a); if (b.init) return b.init(a), !0 }
                this.currentModuleIx = 0;
                0 < a ? (this.exiting = !0, this.exitAnchor.focus()) : this.chart.container.focus();
                return !1
            },
            updateExitAnchor: function() {
                var a = c("highcharts-end-of-chart-marker-" + this.chart.index);
            ...
            updateContainerTabindex: function() {
                ...
                var b = this.chart.container,
                    r = b.getAttribute("tabIndex");
                a && !r ? b.setAttribute("tabindex", "0") : a || "0" !== r || b.removeAttribute("tabindex")
            },
            ...
            createExitAnchor: function() {
                var a = this.chart,
                    b = this.exitAnchor = h.createElement("div");
            ...
            addExitAnchorEventsToEl: function(a) {
                ...
                this.eventProvider.addEvent(a, "focus", function(a) {
                    a = a || e.event;
                    a.relatedTarget && b.container.contains(a.relatedTarget) || d.exiting ? d.exiting = !1 : (b.renderTo.focus(), a.preventDefault(), d.modules && d.modules.length && (d.currentModuleIx = d.modules.length - 1, (a = d.modules[d.currentModuleIx]) && a.validate &&
    ...
    t(a, "modules/accessibility/components/LegendComponent.js", [a["parts/Globals.js"], a["parts/Legend.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/htmlUtilities.js"]],
        function(a, f, l, m, p, e) {
            var h = l.addEvent,
                g = l.extend,
                n = l.fireEvent,
                c = e.stripHTMLTagsFromString,
                d = e.removeElement;
            a.Chart.prototype.highlightLegendItem = function(b) {
                var a = this.legend.allItems,
                    d = this.highlightedLegendItemIx;
                if (a[b]) {
                    a[d] && n(a[d].legendGroup.element, "mouseout");
                    d = this.legend;
                    var c = d.allItems[b].pageIx,
                        e = d.currentPage;
                    "undefined" !== typeof c && c + 1 !== e && d.scroll(1 + c - e);
                    this.setFocusToElement(a[b].legendItem, a[b].a11yProxyElement);
                    n(a[b].legendGroup.element, "mouseover");
                    return !0
                }
                return !1
            };
            ...
            g(a.prototype, {
                ...
                updateProxies: function() {
                    ...
                    var a = this.chart,
                        c = a.legend && a.legend.allItems,
                        k = a.options.legend.accessibility || {};
                    !c || !c.length || a.colorAxis && a.colorAxis.length || !1 === k.enabled || (this.addLegendProxyGroup(), this.proxyLegendItems(), this.updateLegendItemProxyVisibility())
                },
                addLegendProxyGroup: function() {
                    var a =
                        this.chart.options.accessibility,
                        d = this.chart.langFormat("accessibility.legend.legendLabel", {});
                    this.legendProxyGroup = this.addProxyGroup({ "aria-label": d, role: "all" === a.landmarkVerbosity ? "region" : null })
                },
                ...
                proxyLegendItem: function(a) {
                    var b = this,
                        d = this.chart.langFormat("accessibility.legend.legendItem", { chart: this.chart, itemName: c(a.name) });
                    ...
                    return new p(this.chart, {
                        keyCodeMap: [
                            [
                                ...
                                function(a) { return d.onKbdArrowKey(this, a) }
                            ],
                            [
                                [a.enter, a.space],
                                function() { return d.onKbdClick(this) }
                            ]
                        ],
                        validate: function() { return d.shouldHaveLegendNavigation() },
                        init: function(a) { return d.onKbdNavigationInit(a) }
                    })
                },
                onKbdArrowKey: function(a, d) {
                    var b = this.keyCodes,
                        c = a.response,
                        r = this.chart,
                        v = r.options.accessibility,
                        e = r.legend.allItems.length;
                    d = d === b.left || d === b.up ? -1 : 1;
                    return r.highlightLegendItem(this.highlightedLegendItemIx + d) ? (this.highlightedLegendItemIx += d, c.success) : 1 < e && v.keyboardNavigation.wrapAround ? (a.init(d), c.success) : c[0 < d ? "next" : "prev"]
                },
                onKbdClick: function(a) {
                    var b = this.chart.legend.allItems[this.highlightedLegendItemIx];
                    b && b.a11yProxyElement &&
                        n(b.a11yProxyElement, "click");
                    return a.response.success
                },
                shouldHaveLegendNavigation: function() {
                    var a = this.chart,
                        d = a.colorAxis && a.colorAxis.length,
    ...
    t(a, "modules/accessibility/components/MenuComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function(a, f, l, m, p, e) {
        function h(a) { return a.exportSVGElements && a.exportSVGElements[0] }
        f = f.extend;
        var g = p.unhideChartElementFromAT,
            n = e.removeElement,
            c = e.getFakeMouseEvent;
        ...
        a.Chart.prototype.hideExportMenu = function() {
            ...
            a && this.exportContextMenu && (a.forEach(function(a) { if ("highcharts-menu-item" === a.className && a.onmouseout) a.onmouseout(c("mouseout")) }), this.highlightedExportItemIx = 0, this.exportContextMenu.hideMenu(), this.container.focus())
        };
        a.Chart.prototype.highlightExportItem = function(a) {
            ...
            if (b && "LI" === b.tagName && (!b.children || !b.children.length)) {
                var k = !!(this.renderTo.getElementsByTagName("g")[0] || {}).focus;
                b.focus && k && b.focus();
                if (d && d.onmouseout) d.onmouseout(c("mouseout"));
                if (b.onmouseover) b.onmouseover(c("mouseover"));
        ...
        f(a.prototype, {
            ...
            onMenuShown: function() {
                ...
                b && (this.addAccessibleContextMenuAttribs(), g(a, b));
            ...
            onChartRender: function() {
                ...
                n(this.exportProxyGroup);
                var c = a.options.exporting,
                    k = h(a);
                c && !1 !== c.enabled && c.accessibility && c.accessibility.enabled && k && k.element && (this.exportProxyGroup = this.addProxyGroup("all" === b.landmarkVerbosity ? { "aria-label": a.langFormat("accessibility.exporting.exportRegionLabel", { chart: a }), role: "region" } : {}), b = h(this.chart), this.exportButtonProxy =
            ...
            onKbdNext: function(a) {
                ...
                a = a.response;
                for (var d = (b.highlightedExportItemIx || 0) + 1; d < b.exportDivElements.length; ++d)
            ...
            onKbdClick: function(a) {
                var b = this.chart,
                    c = b.exportDivElements[b.highlightedExportItemIx],
                    d = h(b).element;
                this.isExportMenuShown ? this.fakeClickEvent(c) : (this.fakeClickEvent(d), b.highlightExportItem(0));
                return a.response.success
            }
        });
        return a
    ...
    t(a, "modules/accessibility/components/SeriesComponent/SeriesKeyboardNavigation.js", [a["parts/Globals.js"], a["parts/Point.js"], a["parts/Utilities.js"], a["modules/accessibility/KeyboardNavigationHandler.js"],
        a["modules/accessibility/utils/EventProvider.js"], a["modules/accessibility/utils/chartUtilities.js"]
    ], function(a, f, l, m, p, e) {
        function h(a) {
            var b = a.index,
                c = a.series.points,
        ...
        function g(a) {
            ...
            return d && !1 === d.enabled || !1 === c.enabled || !1 === a.options.enableMouseTracking || !a.visible || b.pointNavigationEnabledThreshold &&
                b.pointNavigationEnabledThreshold <= a.points.length
        }

        function n(a) { var b = a.series.chart.options.accessibility; return a.isNull && b.keyboardNavigation.seriesNavigation.skipNullPoints || !1 === a.visible || g(a.series) }

        function c(a, b, c, d) {
            var e = Infinity,
                v = b.points.length,
                w = function(a) { return !(k(a.plotX) && k(a.plotY)) };
            if (!w(a)) { for (; v--;) { var u = b.points[v]; if (!w(u) && (u = (a.plotX - u.plotX) * (a.plotX - u.plotX) * (c || 1) + (a.plotY - u.plotY) * (a.plotY - u.plotY) * (d || 1), u < e)) { e = u; var r = v } } return k(r) ? b.points[r] : void 0 }
        }
        ...
        a.Chart.prototype.highlightAdjacentPoint = function(a) {
            ...
            if (c) { if (b = b[c.series.index + (a ? 1 : -1)], d = k[d + (a ? 1 : -1)], !d && b && (d = b.points[a ? 0 : b.points.length - 1]), !d) return !1 } else d = a ? b[0].points[0] : e;
            return n(d) ? (b = d.series, g(b) ?
        ...
        a.Series.prototype.highlightFirstValidPoint = function() {
            var a = this.chart.highlightedPoint,
                b = (a && a.series) === this ? h(a) : 0;
            a = this.points;
            var c = a.length;
            if (a && c) {
                for (var d = b; d < c; ++d)
                    if (!n(a[d])) return a[d].highlight();
                for (; 0 <= b; --b)
                    if (!n(a[b])) return a[b].highlight()
            }
            return !1
        };
        a.Chart.prototype.highlightAdjacentSeries = function(a) {
            ...
            var e = (b =
                this.series && this.series[this.series.length - 1]) && b.points && b.points[b.points.length - 1];
            if (!this.highlightedPoint) return b = a ? this.series && this.series[0] : b, (e = a ? b && b.points && b.points[0] : e) ? e.highlight() : !1;
            b = this.series[d.series.index + (a ? -1 : 1)];
            if (!b) return !1;
            e = c(d, b, 4);
            if (!e) return !1;
            if (g(b)) return e.highlight(), a = this.highlightAdjacentSeries(a), a ? a : (d.highlight(), !1);
            e.highlight();
        ...
        a.Chart.prototype.highlightAdjacentPointVertical = function(a) {
            var b = this.highlightedPoint,
                d = Infinity,
                c;
            if (!k(b.plotX) || !k(b.plotY)) return !1;
            this.series.forEach(function(e) {
                g(e) || e.points.forEach(function(r) {
                    if (k(r.plotY) && k(r.plotX) && r !== b) {
                        var w = r.plotY - b.plotY,
                            g = Math.abs(r.plotX - b.plotX);
                        g = Math.abs(w) * Math.abs(w) + g * g * 4;
                        e.yAxis && e.yAxis.reversed && (w *= -1);
                        !(0 >= w && a || 0 <= w && !a || 5 > g || n(r)) && g < d && (d = g, c = r)
                    }
                })
            });
        ...
        r(b.prototype, {
            init: function() {
                ...
                e.addEvent(c, "drilldown", function(a) {
                    a = a.point;
                    var d = a.series;
                    b.lastDrilledDownPoint = { x: a.x, y: a.y, seriesName: d ? d.name : "" }
                });
                e.addEvent(c, "drillupall", function() { setTimeout(function() { b.onDrillupAll() }, 10) })
            },
            onDrillupAll: function() {
                var a = this.lastDrilledDownPoint,
                    b = this.chart,
                    d = a && q(b, a.seriesName),
                    c;
                a && d && k(a.x) && k(a.y) && (c = x(d, a.x, a.y));
            ...
            getKeyboardNavigationHandler: function() {
                ...
                return new m(d, {
                    keyCodeMap: [
                        [c ? [b.up, b.down] : [b.left, b.right], function(b) { return a.onKbdSideways(this, b) }],
                        [c ? [b.left, b.right] : [b.up, b.down], function(b) { return a.onKbdVertical(this, b) }],
                        [
                            [b.enter, b.space],
                            function() { d.highlightedPoint && d.highlightedPoint.firePointEvent("click"); return this.response.success }
                        ]
                    ],
                    init: function(b) {
            ...
            onKbdSideways: function(a, b) { var d = this.keyCodes; return this.attemptHighlightAdjacentPoint(a, b === d.right || b === d.down) },
            onKbdVertical: function(a, b) {
                var d = this.chart,
                    c = this.keyCodes;
                b = b === c.down || b === c.right;
                c = d.options.accessibility.keyboardNavigation.seriesNavigation;
                if (c.mode && "serialize" === c.mode) return this.attemptHighlightAdjacentPoint(a, b);
                d[d.highlightedPoint && d.highlightedPoint.series.keyboardMoveVertical ? "highlightAdjacentPointVertical" :
                    "highlightAdjacentSeries"](b);
                return a.response.success
            },
            onHandlerInit: function(a, b) {
                var c = this.chart;
                if (0 < b) d(c);
                else { b = c.series.length; for (var e; b-- && !(c.highlightedPoint = c.series[b].points[c.series[b].points.length - 1], e = c.series[b].highlightFirstValidPoint());); }
                return a.response.success
            },
            onHandlerTerminate: function() {
                var a = this.chart,
                    b = a.highlightedPoint;
                a.tooltip && a.tooltip.hide(0);
                b && (b.onMouseOut(), delete a.highlightedPoint)
            },
    ...
    t(a, "modules/accessibility/components/AnnotationsA11y.js", [a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function(a, f) {
        function q(a) {
            return (a.annotations || []).reduce(function(a, b) { var c;!1 !== (null === (c = b.options) || void 0 === c ? void 0 : c.visible) && (a = a.concat(b.labels)); return a }, [])
        }

        function m(a) { var c, b, e, k, g = null === (b = null === (c = a.options) || void 0 === c ? void 0 : c.accessibility) || void 0 === b ? void 0 : b.description; return g ? g : (null === (k = null === (e = a.graphic) || void 0 === e ? void 0 : e.text) || void 0 === k ? void 0 : k.textStr) || "" }

        function p(a) {
            var c, b, e = null === (b = null === (c = a.options) || void 0 === c ? void 0 : c.accessibility) || void 0 === b ? void 0 : b.description;
            if (e) return e;
            c = a.chart;
            b = m(a);
            e = a.points.filter(function(a) { return !!a.graphic }).map(function(a) {
                var b, c;
                if (!(c = null === (b = null === a || void 0 === a ? void 0 : a.accessibility) || void 0 === b ? void 0 : b.valueDescription)) {
                    var d, e;
                    c = (null === (e = null === (d = null === a || void 0 === a ? void 0 : a.graphic) || void 0 === d ? void 0 : d.element) || void 0 === e ? void 0 : e.getAttribute("aria-label")) || ""
                }
                a = (null === a || void 0 === a ? void 0 : a.series.name) || "";
                return (a ? a + ", " : "") + "data point " + c
            }).filter(function(a) { return !!a });
            var k = e.length;
            a = "accessibility.screenReaderSection.annotations.description" +
                (1 < k ? "MultiplePoints" : k ? "SinglePoint" : "NoPoints");
            b = { annotationText: b, numPoints: k, annotationPoint: e[0], additionalAnnotationPoints: e.slice(1) };
            return c.langFormat(a, b)
        }

        function e(a) { return q(a).map(function(a) { return (a = g(n(p(a)))) ? "<li>" + a + "</li>" : "" }) }
        var h = a.inArray,
            g = f.escapeStringForHTML,
            n = f.stripHTMLTagsFromString;
        return {
            getAnnotationsInfoHTML: function(a) { var c = a.annotations; return c && c.length ? "<ul>" + e(a).join(" ") + "</ul>" : "" },
            getAnnotationLabelDescription: p,
            getAnnotationListItems: e,
            getPointAnnotationTexts: function(a) {
                var c =
                    q(a.series.chart).filter(function(b) { return -1 < h(a, b.points) });
                return c.length ? c.map(function(a) { return "" + m(a) }) : []
            }
        }
    });
    t(a, "modules/accessibility/components/SeriesComponent/SeriesDescriber.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/components/AnnotationsA11y.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["parts/Tooltip.js"]], function(a, f, l, m, p, e) {
        ...
        function g(a) { var b = a.chart.options.accessibility.series.pointDescriptionEnabledThreshold; return !!(!1 !== b && a.points && a.points.length >= b) }

        function n(a) { var b = a.options.accessibility || {}; return !g(a) && !b.exposeAsGroupOnly }
        ...
        function d(a, b) {
            ...
            c = c.options.lang;
            return E(b) ? A(b, d.valueDecimals || a.valueDecimals || -1, c.decimalPoint, c.accessibility.thousandsSep || c.thousandsSep) : b
        }

        function b(a) { var b = (a.options.accessibility || {}).description; return b && a.chart.langFormat("accessibility.series.description", { description: b, series: a }) || "" }
        ...
        function k(a) {
            var b = a.series,
                c = b.chart,
                d = c.options.accessibility.point || {};
            if (b.xAxis && b.xAxis.isDatetimeAxis) return b = e.prototype.getXDateFormat.call({ getDateFormat: e.prototype.getDateFormat, chart: c }, a, c.options.tooltip, b.xAxis), d = d.dateFormatter && d.dateFormatter(a) || d.dateFormat || b, c.time.dateFormat(d, a.x, void 0)
        }

        function x(a) {
            var b = k(a),
                c = (a.series.xAxis || {}).categories && F(a.category) && ("" + a.category).replace("<br/>", " "),
        ...
        function q(a, b, c) {
            var e = b || "",
                k = c || "";
            return a.series.pointArrayMap.reduce(function(b, c) { b += b.length ? ", " : ""; var w = d(a, z(a[c], a.options[c])); return b + (c + ": " + e + w + k) }, "")
        }
        ...
        function v(a) {
            var b = a.series,
                ...
                e = b.tooltipOptions || {},
                k = c.valuePrefix || e.valuePrefix || "";
            c = c.valueSuffix || e.valueSuffix || "";
            e = d(a, a["undefined" !== typeof a.value ? "value" : "y"]);
            return a.isNull ? b.chart.langFormat("accessibility.series.nullPointValue", { point: a }) : b.pointArrayMap ? q(a, k, c) : k + e + c
        }

        function u(a) {
            var b = a.series,
                c = b.chart,
                d = c.options.accessibility.point.valueDescriptionFormat,
                e = (b = z(b.xAxis && b.xAxis.options.accessibility && b.xAxis.options.accessibility.enabled, !c.angular)) ? x(a) : "";
            a = { point: a, index: F(a.index) ? a.index + 1 : "", xDescription: e, value: v(a), separator: b ? ", " : "" };
            return w(d, a, c)
        }
        ...
        function t(a) {
            var b = a.series,
                c = b.chart,
                d = u(a),
                e = a.options && a.options.accessibility && a.options.accessibility.description;
            e = e ? " " + e : "";
            b = 1 < c.series.length && b.name ?
                " " + b.name + "." : "";
            c = a.series.chart;
            var k = K(a),
                w = { point: a, annotations: k };
            c = k.length ? c.langFormat("accessibility.series.pointAnnotationsDescription", w) : "";
            a.accessibility = a.accessibility || {};
            a.accessibility.valueDescription = d;
            return d + e + b + (c ? " " + c : "")
        }
        ...
        function C(a) {
            var b = n(a),
                d = c(a);
            (b || d) && a.points.forEach(function(a) {
                var c;
                if (!(c = a.graphic && a.graphic.element) && (c = a.series && a.series.is("sunburst"), c = a.isNull && !c)) {
                    var d = a.series,
                        e = h(a);
                    d = (c = e && e.graphic) ? c.parentGroup : d.graph || d.group;
                    e = e ? {
                        x: z(a.plotX,
                            e.plotX, 0),
                        y: z(a.plotY, e.plotY, 0)
                    } : { x: z(a.plotX, 0), y: z(a.plotY, 0) };
                    e = a.series.chart.renderer.rect(e.x, e.y, 1, 1);
                    e.attr({ "class": "highcharts-a11y-dummy-point", fill: "none", opacity: 0, "fill-opacity": 0, "stroke-opacity": 0 });
                    d && d.element ? (a.graphic = e, a.hasDummyGraphic = !0, e.add(d), d.element.insertBefore(e.element, c ? c.element : null), c = e.element) : c = void 0
                }
        ...
        function y(a) {
            var c = a.chart,
                d = c.types || [],
                e = b(a),
                k = function(b) { return c[b] && 1 < c[b].length && a[b] },
                w = r(a, "xAxis"),
                g = r(a, "yAxis"),
                n = { name: a.name || "", ix: a.index + 1, numSeries: c.series && c.series.length, numPoints: a.points && a.points.length, series: a };
            d = 1 < d.length ? "Combination" : "";
            return (c.langFormat("accessibility.series.summary." +
                a.type + d, n) || c.langFormat("accessibility.series.summary.default" + d, n)) + (e ? " " + e : "") + (k("yAxis") ? " " + g : "") + (k("xAxis") ? " " + w : "")
        }
        var A = a.numberFormat,
            w = a.format,
            D = f.find,
            E = f.isNumber,
            z = f.pick,
            F = f.defined,
            K = l.getPointAnnotationTexts,
            G = m.escapeStringForHTML,
            L = m.reverseChildNodes,
            H = m.stripHTMLTagsFromString,
            J = p.getAxisDescription,
            M = p.getSeriesFirstPointElement,
            N = p.getSeriesA11yElement,
            O = p.unhideChartElementFromAT;
        return {
            describeSeries: function(a) {
                ...
                if (d) {
                    ...
                    var k = (a.options.accessibility || {}).exposeAsGroupOnly;
                    b.options3d && b.options3d.enabled && c || !(c || e || k || g(a)) ? d.setAttribute("aria-label", "") : (b = a.chart.options.accessibility, c = b.landmarkVerbosity, (a.options.accessibility || {}).exposeAsGroupOnly ? d.setAttribute("role", "img") : "all" === c && d.setAttribute("role", "region"), d.setAttribute("tabindex", "-1"), d.setAttribute("aria-label",
        ...
        l = function() {
            ...
            a.prototype.announce = function(a) {
                ...
                this.clearAnnouncementRegionTimer = setTimeout(function() {
                    ...
                    delete e.clearAnnouncementRegionTimer
                }, 1E3)
            };
    ...
    t(a, "modules/accessibility/components/SeriesComponent/NewDataAnnouncer.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/components/SeriesComponent/SeriesDescriber.js"], a["modules/accessibility/utils/Announcer.js"], a["modules/accessibility/utils/EventProvider.js"]],
        function(a, f, l, m, p, e) {
            function h(a) { var b = a.series.data.filter(function(b) { return a.x === b.x && a.y === b.y }); return 1 === b.length ? b[0] : a }

            function g(a, b) { var c = (a || []).concat(b || []).reduce(function(a, b) { a[b.name + b.index] = b; return a }, {}); return Object.keys(c).map(function(a) { return c[a] }) }
            var n = f.extend,
                c = f.defined,
                d = l.getChartTitle,
                b = m.defaultPointDescriptionFormatter,
                r = m.defaultSeriesDescriptionFormatter;
            f = function(a) { this.chart = a };
            n(f.prototype, {
                init: function() {
                    var a = this.chart,
                ...
                addEventListeners: function() {
                    ...
                    d.addEvent(c, "redraw", function() { b.announceDirtyData() })
                },
                ...
                onPointAdded: function(a) {
                    ...
                    this.chart === b && b.options.accessibility.announceNewData.enabled && (this.dirty.newPoint = c(this.dirty.newPoint) ? void 0 : a)
                },
                ...
                queueAnnouncement: function(a,
                    b, c) {
                    var d = this,
                        e = this.chart.options.accessibility.announceNewData;
                    if (e.enabled) {
                        var k = +new Date;
                        e = Math.max(0, e.minAnnounceInterval - (k - this.lastAnnouncementTime));
                        a = g(this.queuedAnnouncement && this.queuedAnnouncement.series, a);
                        if (b = this.buildAnnouncementMessage(a, b, c)) this.queuedAnnouncement && clearTimeout(this.queuedAnnouncementTimer), this.queuedAnnouncement = { time: k, message: b, series: a }, this.queuedAnnouncementTimer = setTimeout(function() {
                ...
                buildAnnouncementMessage: function(c, e, g) {
                    var k = this.chart,
                        n = k.options.accessibility.announceNewData;
                    if (n.announcementFormatter && (c = n.announcementFormatter(c, e, g), !1 !== c)) return c.length ? c : null;
                    c = a.charts && 1 < a.charts.length ? "Multiple" : "Single";
                    c = e ? "newSeriesAnnounce" + c : g ? "newPointAnnounce" + c : "newDataAnnounce";
                    n = d(k);
                    return k.langFormat("accessibility.announceNewData." + c, {
                        chartTitle: n,
                        seriesDesc: e ? r(e) : null,
                        pointDesc: g ? b(g) : null,
                        point: g,
                        series: e
                    })
                }
    ...
    t(a, "modules/accessibility/components/SeriesComponent/forcedMarkers.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function(a, f) {
        function q(a) { p(!0, a, { marker: { enabled: !0, states: { normal: { opacity: 0 } } } }) }
        var m = f.addEvent,
            p = f.merge;
        return function() {
            m(a.Series, "render", function() {
                var a = this.options,
                    h = this.chart.options.accessibility.enabled,
                    g = !1 !== (this.options.accessibility && this.options.accessibility.enabled);
                var n = this.chart.options.accessibility;
                n = this.points.length <
                    n.series.pointDescriptionEnabledThreshold || !1 === n.series.pointDescriptionEnabledThreshold;
                var c = this.chart.options.accessibility.keyboardNavigation.seriesNavigation;
                c = this.points.length < c.pointNavigationEnabledThreshold || !1 === c.pointNavigationEnabledThreshold;
                if (h && g && (n || c)) {
                    if (a.marker && !1 === a.marker.enabled && (this.a11yMarkersForced = !0, q(this.options)), this._hasPointMarkers && this.points && this.points.length)
                        for (a = this.points, h = a.length; h--;) g = a[h].options, g.marker && (g.marker.enabled ? p(!0, g.marker, { states: { normal: { opacity: g.marker.states && g.marker.states.normal && g.marker.states.normal.opacity || 1 } } }) : q(g))
    ...
    t(a, "modules/accessibility/components/SeriesComponent/SeriesComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/components/SeriesComponent/SeriesKeyboardNavigation.js"], a["modules/accessibility/components/SeriesComponent/NewDataAnnouncer.js"], a["modules/accessibility/components/SeriesComponent/forcedMarkers.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/components/SeriesComponent/SeriesDescriber.js"], a["parts/Tooltip.js"]], function(a, f, l, m, p, e, h, g, n) {
        f =
            f.extend;
        var c = h.hideSeriesFromAT,
            d = g.describeSeries;
        a.SeriesAccessibilityDescriber = g;
        e();
        a = function() {};
        a.prototype = new l;
        f(a.prototype, {
            ...
            hideTooltipFromATWhenShown: function() {
                var a = this;
                this.addEvent(n, "refresh", function() {
            ...
            onChartRender: function() { this.chart.series.forEach(function(a) {!1 !== (a.options.accessibility && a.options.accessibility.enabled) && a.visible ? d(a) : c(a) }) },
    ...
    t(a, "modules/accessibility/components/ZoomComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function(a, f, l, m, p, e) {
        var h = f.extend,
            g = f.pick,
            n = p.unhideChartElementFromAT,
            c = e.setElAttrs,
            d = e.removeElement;
        a.Axis.prototype.panStep = function(a, c) {
            var b = c || 3;
            c = this.getExtremes();
            var d = (c.max - c.min) / b * a;
            b = c.max + d;
            d = c.min + d;
            var e = b - d;
            0 > a && d < c.dataMin ? (d = c.dataMin, b = d + e) : 0 < a && b > c.dataMax && (b = c.dataMax, d = b - e);
            this.setExtremes(d, b)
        };
        a = function() {};
        a.prototype = new l;
        h(a.prototype, {
            init: function() {
                var a = this,
                    c = this.chart;
                ["afterShowResetZoom", "afterDrilldown", "drillupall"].forEach(function(b) { a.addEvent(c, b, function() { a.updateProxyOverlays() }) })
            },
            onChartUpdate: function() {
                var a = this.chart,
                    c =
                    this;
                a.mapNavButtons && a.mapNavButtons.forEach(function(b, d) {
                    n(a, b.element);
                    c.setMapNavButtonAttrs(b.element, "accessibility.zoom.mapZoom" + (d ? "Out" : "In"))
                })
            },
            setMapNavButtonAttrs: function(a, d) {
                var b = this.chart;
                d = b.langFormat(d, { chart: b });
                c(a, { tabindex: -1, role: "button", "aria-label": d })
            },
            ...
            updateProxyOverlays: function() {
                ...
                a.resetZoomButton && this.recreateProxyButtonAndGroup(a.resetZoomButton,
                    "resetZoomProxyButton", "resetZoomProxyGroup", a.langFormat("accessibility.zoom.resetZoomButton", { chart: a }));
            ...
            recreateProxyButtonAndGroup: function(a, c, e, g) {
                d(this[e]);
                this[e] = this.addProxyGroup();
                this[c] = this.createProxyButton(a, this[e], { "aria-label": g, tabindex: -1 })
            },
                ...
                return new m(c, {
                    keyCodeMap: [
                        [
                            ...
                            function(a) { return d.onMapKbdArrow(this, a) }
                        ],
                        [
                            [a.tab],
                            function(a, b) { return d.onMapKbdTab(this, b) }
                        ],
                        [
                            [a.space, a.enter],
                    ...
                    validate: function() { return !!(c.mapZoom && c.mapNavButtons && c.mapNavButtons.length) },
                    init: function(a) { return d.onMapNavInit(a) }
                })
            },
            onMapKbdArrow: function(a, c) {
                var b = this.keyCodes;
                this.chart[c === b.up || c === b.down ? "yAxis" : "xAxis"][0].panStep(c === b.left ||
                    c === b.up ? -1 : 1);
                return a.response.success
            },
            onMapKbdTab: function(a, c) {
                var b = this.chart;
                a = a.response;
                var d = (c = c.shiftKey) && !this.focusedMapNavButtonIx || !c && this.focusedMapNavButtonIx;
                b.mapNavButtons[this.focusedMapNavButtonIx].setState(0);
                if (d) return b.mapZoom(), a[c ? "prev" : "next"];
                this.focusedMapNavButtonIx += c ? -1 : 1;
                c = b.mapNavButtons[this.focusedMapNavButtonIx];
            ...
            simpleButtonNavigation: function(a, c, d) {
                var b = this.keyCodes,
                    e = this,
                    n = this.chart;
                return new m(n, {
                    ...
                    validate: function() { return n[a] && n[a].box && e[c] },
                    init: function() { n.setFocusToElement(n[a].box, e[c]) }
                })
            },
    ...
    t(a, "modules/accessibility/components/RangeSelectorComponent.js", [a["parts/Globals.js"],
        ...
        f = f.extend;
        var h = p.unhideChartElementFromAT,
            g = e.setElAttrs;
        a.Chart.prototype.highlightRangeSelectorButton = function(a) {
            var c = this.rangeSelector.buttons,
                d = this.highlightedRangeSelectorItemIx;
            "undefined" !== typeof d && c[d] && c[d].setState(this.oldRangeSelectorItemState ||
                0);
        ...
        f(a.prototype, {
            ...
            setRangeButtonAttrs: function(a) {
                var c = this.chart;
                c = c.langFormat("accessibility.rangeSelector.buttonText", { chart: c, buttonText: a.text && a.text.textStr });
                g(a.element, { tabindex: -1, role: "button", "aria-label": c })
            },
            setRangeInputAttrs: function(a, c) {
                var d = this.chart;
                g(a, { tabindex: -1, role: "textbox", "aria-label": d.langFormat(c, { chart: d }) })
            },
            ...
            onButtonNavKbdClick: function(a) {
                a = a.response;
                var c = this.chart;
                3 !== c.oldRangeSelectorItemState && this.fakeClickEvent(c.rangeSelector.buttons[c.highlightedRangeSelectorItemIx].element);
                return a.success
            },
            getRangeSelectorInputNavigation: function() {
                ...
                return new m(a, {
                    keyCodeMap: [
                        [
                            [c.tab, c.up, c.down],
                            function(a, e) { return d.onInputKbdMove(this, a === c.tab && e.shiftKey || a === c.up ? -1 : 1) }
                        ]
                    ],
                    validate: function() {
            ...
            onInputKbdMove: function(a, c) {
                var d = this.chart;
                a = a.response;
                var b = d.highlightedInputRangeIx += c;
                if (1 < b || 0 > b) return a[0 < c ? "next" : "prev"];
            ...
            onInputNavInit: function(a) {
                var c =
                    this.chart;
                a = 0 < a ? 0 : 1;
                c.highlightedInputRangeIx = a;
                c.rangeSelector[a ? "maxInput" : "minInput"].focus()
            },
    ...
    t(a, "modules/accessibility/components/InfoRegionsComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"],
        a["modules/accessibility/utils/Announcer.js"], a["modules/accessibility/components/AnnotationsA11y.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]
    ], function(a, f, l, m, p, e, h) {
        function g(a) { return a.replace(/&lt;(h[1-7]|p|div|ul|ol|li)&gt;/g, "<$1>").replace(/&lt;&#x2F;(h[1-7]|p|div|ul|ol|li|a|button)&gt;/g, "</$1>").replace(/&lt;(div|a|button) id=&quot;([a-zA-Z\-0-9#]*?)&quot;&gt;/g, '<$1 id="$2">') }
        var n = a.win.document,
            c = f.extend,
            d = f.format,
            b = f.pick,
            r = p.getAnnotationsInfoHTML,
            k = e.unhideChartElementFromAT,
            q = e.getChartTitle,
            t = e.getAxisDescription,
            v = h.addClass,
            u = h.setElAttrs,
            B = h.escapeStringForHTML,
            C = h.stripHTMLTagsFromString,
            y = h.getElement,
            A = h.visuallyHideElement;
        a.Chart.prototype.getTypeDescription = function(a) {
            ...
            if ("map" === b) return c.mapTitle ?
                this.langFormat("accessibility.chartTypes.mapTypeDescription", c) : this.langFormat("accessibility.chartTypes.unknownMap", c);
        ...
        c(f.prototype, {
            ...
            initRegionsDefinitions: function() {
                ...
                this.screenReaderSections = {
                    ...
                    after: {
                        element: null,
                        buildContent: function(b) { var c = b.options.accessibility.screenReaderSection.afterChartFormatter; return c ? c(b) : a.defaultAfterChartFormatter() },
            ...
            setLinkedDescriptionAttrs: function() {
                ...
                a && (a.setAttribute("aria-hidden", "true"), v(a, "highcharts-linked-description"))
            },
            ...
            setScreenReaderSectionAttribs: function(a, b) {
                ...
                u(a, { id: "highcharts-screen-reader-region-" + b + "-" + c.index, "aria-label": d });
            ...
            defaultBeforeChartFormatter: function() {
                var b = this.chart,
                    ...
                    e = "highcharts-a11y-sonify-data-btn-" + b.index,
                    h = "hc-linkto-highcharts-data-table-" + b.index,
                    f = r(b),
                    k = b.langFormat("accessibility.screenReaderSection.annotations.heading", { chart: b });
                d = { chartTitle: q(b), typeDescription: this.getTypeDescriptionText(), chartSubtitle: this.getSubtitleText(), chartLongdesc: this.getLongdescText(), xAxisDescription: d.xAxis, yAxisDescription: d.yAxis, playAsSoundButton: b.sonify ? this.getSonifyButtonText(e) : "", viewTableButton: b.getCSV ? this.getDataTableButtonText(h) : "", annotationsTitle: f ? k : "", annotationsList: f };
                b = a.i18nFormat(c, d, b);
                this.dataTableButtonId = h;
                this.sonifyButtonId =
                    e;
                return g(B(b)).replace(/<(\w+)[^>]*?>\s*<\/\1>/g, "")
            },
            ...
            getLinkedDescription: function() { var a = this.linkedDescriptionElement; return C(a && a.innerHTML || "") },
            ...
            getTypeDescriptionText: function() { var a = this.chart; return a.types ? a.options.accessibility.typeDescription || a.getTypeDescription(a.types) : "" },
            getDataTableButtonText: function(a) {
                var b = this.chart;
                b = b.langFormat("accessibility.table.viewAsDataTableButtonText", { chart: b, chartTitle: q(b) });
                return '<a id="' + a + '">' + b + "</a>"
            },
            getSonifyButtonText: function(a) {
                var b, c = this.chart;
                if (!1 === (null === (b = c.options.sonification) || void 0 === b ? void 0 : b.enabled)) return "";
                b = c.langFormat("accessibility.sonification.playAsSoundButtonText", { chart: c, chartTitle: q(c) });
                return '<button id="' + a + '">' + b + "</button>"
            },
            getSubtitleText: function() { var a = this.chart.options.subtitle; return C(a && a.text || "") },
            ...
            onDataTableCreated: function(a) {
                var b = this.chart;
                b.options.accessibility.enabled && (this.viewDataTableButton && this.viewDataTableButton.setAttribute("aria-expanded",
            ...
            initSonifyButton: function(a) {
                ...
                c && d && (u(c, { tabindex: "-1" }), c.onclick = function(a) {
                    var b;
                    ((null === (b = d.options.accessibility) || void 0 === b ? void 0 : b.screenReaderSection.onPlayAsSoundClick) || e).call(this, a, d)
                })
            },
            initDataTableButton: function(a) {
                ...
                b && (u(b, { role: "button", tabindex: "-1", "aria-expanded": !!y(a), href: "#" + a }), b.onclick = c.options.accessibility.screenReaderSection.onViewDataTableClick || function() { c.viewData() })
            },
            getAxesDescription: function() {
                var a = this.chart,
                    c = function(c, d) { c = a[c]; return 1 < c.length || c[0] && b(c[0].options.accessibility && c[0].options.accessibility.enabled, d) },
                    d = !!a.types && 0 > a.types.indexOf("map"),
                    e = !!a.hasCartesianSeries,
                    g = c("xAxis", !a.angular && e && d);
                c = c("yAxis", e && d);
                d = {};
            ...
            getAxisDescriptionText: function(a) {
                var b = this,
                    c = this.chart,
                    d = c[a];
                return c.langFormat("accessibility.axis." + a + "Description" + (1 < d.length ? "Plural" : "Singular"), { chart: c, names: d.map(function(a) { return t(a) }), ranges: d.map(function(a) { return b.getAxisRangeDescription(a) }), numAxes: d.length })
            },
            getAxisRangeDescription: function(a) {
                var b = a.options || {};
                return b.accessibility && "undefined" !== typeof b.accessibility.rangeDescription ?
            ...
            getAxisTimeLengthDesc: function(a) {
                ...
                c.Days = c.Hours / 24;
                ["Minutes", "Hours", "Days"].forEach(function(a) { 2 < c[a] && (d = a) });
            ...
            getAxisFromToDescription: function(a) {
                var b = this.chart,
                    ...
                    d = function(d) { return a.isDatetimeAxis ? b.time.dateFormat(c, a[d]) : a[d] };
            ...
            destroy: function() {
                var a;
                null === (a = this.announcer) || void 0 === a ? void 0 : a.destroy()
            }
        });
        return f
    });
    t(a, "modules/accessibility/components/ContainerComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/AccessibilityComponent.js"]], function(a, f, l, m, p) {
        ...
        a = f.extend;
        var h = l.stripHTMLTagsFromString,
            g = m.unhideChartElementFromAT,
            n = m.getChartTitle;
        l = function() {};
        l.prototype = new p;
        a(l.prototype, {
            ...
            handleSVGTitleElement: function() {
                var a = this.chart,
                    ...
                    b = h(a.langFormat("accessibility.svgContainerTitle", { chartTitle: n(a) }));
                if (b.length) {
            ...
            setSVGContainerLabel: function() {
                var a = this.chart,
                    d = h(a.langFormat("accessibility.svgContainerLabel", { chartTitle: n(a) }));
            ...
            setRenderToAttrs: function() {
                ...
                "disabled" !== a.options.accessibility.landmarkVerbosity ?
                    a.renderTo.setAttribute("role", "region") : a.renderTo.removeAttribute("role");
            ...
            makeCreditsAccessible: function() {
                var a = this.chart,
                    d = a.credits;
                d && (d.textStr && d.element.setAttribute("aria-label", h(a.langFormat("accessibility.credits", { creditsStr: d.textStr }))), g(a, d.element))
            },
            destroy: function() { this.chart.renderTo.setAttribute("aria-hidden", !0) }
        });
        return l
    });
    t(a, "modules/accessibility/high-contrast-mode.js", [a["parts/Globals.js"]], function(a) {
        var f = a.isMS,
            l = a.win,
            m = l.document;
        return {
            isHighContrastModeActive: function() {
                ...
                if (f && l.getComputedStyle) {
                    ...
                    var e = (a.currentStyle || l.getComputedStyle(a)).backgroundImage;
            ...
            setHighContrastTheme: function(a) {
                ...
                a.series.forEach(function(a) {
                    var g = e.plotOptions[a.type] || {};
                    a.update({ color: g.color || "windowText", colors: [g.color || "windowText"], borderColor: g.borderColor || "window" });
                    a.points.forEach(function(a) { a.options && a.options.color && a.update({ color: g.color || "windowText", borderColor: g.borderColor || "window" }, !1) })
                });
                a.redraw()
            }
        }
        ...
        return {
            ...
            rangeSelector: {
                buttonTheme: {
                    ...
                    stroke: "windowText",
                    style: { color: "windowText" },
                    states: { hover: { fill: "window", stroke: "windowText", style: { color: "windowText" } }, select: { fill: "#444", stroke: "windowText", style: { color: "windowText" } } }
                },
    ...
    t(a, "modules/accessibility/options/deprecatedOptions.js", [a["parts/Utilities.js"]],
        function(a) {
            function f(a, d, b) { g("Highcharts: Deprecated option " + d + " used. This will be removed from future versions of Highcharts. Use " + b + " instead.", !1, a) }

            function l(a, d, b) {
                for (var c, e = 0; e < d.length - 1; ++e) c = d[e], a = a[c] = n(a[c], {});
                a[d[d.length - 1]] = b
            }

            function m(a, d, b, e) {
                function c(a, b) { return b.reduce(function(a, b) { return a[b] }, a) }
                var g = c(a.options, d),
                    h = c(a.options, b);
                Object.keys(e).forEach(function(c) { var k = g[c]; "undefined" !== typeof k && (l(h, e[c], k), f(a, d.join(".") + "." + c, b.join(".") + "." + e[c].join("."))) })
            }

            function p(a) {
                var c = a.options.chart || {},
                    b = a.options.accessibility || {};
                ["description", "typeDescription"].forEach(function(d) { c[d] && (b[d] = c[d], f(a, "chart." + d, "accessibility." + d)) })
            }

            function e(a) {
                a.axes.forEach(function(c) {
                    (c = c.options) && c.description && (c.accessibility = c.accessibility || {}, c.accessibility.description = c.description, f(a, "axis.description", "axis.accessibility.description"))
                })
            }
            ...
            return function(a) {
                ...
                m(a, ["accessibility", "keyboardNavigation"], ["accessibility", "keyboardNavigation", "seriesNavigation"], { skipNullPoints: ["skipNullPoints"], mode: ["mode"] });
    ...
    t(a, "modules/accessibility/a11y-i18n.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function(a, f) {
        function l(a, h) {
            ...
            if (-1 < e) {
                ...
                f = a.substring(c + 1);
                c = a.substring(e + 6, c).split(",");
                e = Number(c[1]);
                a = "";
                if (h = h[c[0]])
                    for (e = isNaN(e) ? h.length : e, e = 0 > e ? h.length + e : Math.min(e, h.length), c = 0; c < e; ++c) a += b + h[c] + f;
                return a.length ? a : ""
            }
            if (-1 < f) {
                b = a.slice(f).indexOf(")") + f;
                a = a.substring(f + 8, b).split(",");
                switch (Number(h[a[0]])) {
                    case 0:
                        a =
                            p(a[4], a[1]);
                ...
                a ? (h = a, h = h.trim && h.trim() || h.replace(/^\s+|\s+$/g, "")) : h = "";
                return h
            }
        ...
        a.i18nFormat = function(a, f, g) {
            ...
            do {
                var b = e(a, d);
                var h = a.substring(d, b && b.begin - 1);
                h.length && c.push({ value: h, type: "constant" });
                b && c.push({ value: b.statement, type: "statement" });
                d = b ? b.end + 1 : d + 1
            } while (b);
            c.forEach(function(a) { "statement" === a.type && (a.value = l(a.value, f)) });
            return m(c.reduce(function(a, b) { return a + b.value }, ""), f, g)
        };
        a.Chart.prototype.langFormat = function(e, f) {
            e = e.split(".");
            for (var g = this.options.lang, h = 0; h < e.length; ++h) g = g && g[e[h]];
            return "string" ===
    ...
    t(a, "modules/accessibility/focusBorder.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function(a, f) {
        ...
        m(a.SVGElement.prototype, {
            addFocusBorder: function(a, f) {
                ...
                this.focusBorder = this.renderer.rect(e.x - a, e.y - a, e.width + 2 * a, e.height + 2 * a, parseInt((f && f.borderRadius || 0).toString(),
                    10)).addClass("highcharts-focus-border").attr({ zIndex: 99 }).add(this.parentGroup);
                this.renderer.styledMode || this.focusBorder.attr({ stroke: f && f.stroke, "stroke-width": f && f.strokeWidth })
            },
        ...
        a.Chart.prototype.setFocusToElement = function(a, f) {
            var e = this.options.accessibility.keyboardNavigation.focusBorder;
            (f = f || a.element) && f.focus && (f.hcEvents && f.hcEvents.focusin || l(f, "focusin", function() {}), f.focus(), e.hideBrowserFocusOutline &&
                (f.style.outline = "none"));
            e.enabled && (this.focusElement && this.focusElement.removeFocusBorder(), a.addFocusBorder(e.margin, { stroke: e.style.color, strokeWidth: e.style.lineWidth, borderRadius: e.style.borderRadius }), this.focusElement = a)
        }
    });
    t(a, "modules/accessibility/accessibility.js", [a["modules/accessibility/utils/chartUtilities.js"], a["parts/Globals.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["parts/Point.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"],
        ...
        a["modules/accessibility/high-contrast-theme.js"], a["modules/accessibility/options/options.js"], a["modules/accessibility/options/langOptions.js"], a["modules/accessibility/options/deprecatedOptions.js"]
    ], function(a, f, l, m, p, e, h, g, n, c, d, b, t, k, x, I, v, u, B) {
        function q(a) { this.init(a) }
        var r = p.addEvent,
            A = p.extend,
            w = p.fireEvent,
            D = p.merge,
            E = f.win.document;
        D(!0, f.defaultOptions, v, { accessibility: { highContrastTheme: I }, lang: u });
        f.A11yChartUtilities = a;
        f.KeyboardNavigationHandler = l;
        f.AccessibilityComponent = e;
        q.prototype = {
            init: function(a) {
                this.chart = a;
                E.addEventListener && a.renderer.isSVG ? (B(a), this.initComponents(), this.keyboardNavigation = new h(a, this.components), this.update()) : a.renderTo.setAttribute("aria-hidden", !0)
            },
            initComponents: function() {
                var a = this.chart,
                    e = a.options.accessibility;
                this.components = { container: new k, infoRegions: new t, legend: new g, chartMenu: new n, rangeSelector: new b, series: new c, zoom: new d };
                e.customComponents && A(this.components, e.customComponents);
            ...
            update: function() {
                var a = this.components,
                    b = this.chart,
                    c = b.options.accessibility;
                w(b, "beforeA11yUpdate");
                b.types = this.getChartTypes();
                this.getComponentOrder().forEach(function(c) {
                    a[c].onChartUpdate();
                    w(b, "afterA11yComponentUpdate", { name: c, component: a[c] })
                });
                this.keyboardNavigation.update(c.keyboardNavigation.order);
                !b.highContrastModeActive && x.isHighContrastModeActive() && x.setHighContrastTheme(b);
        ...
        r(f.Chart, "render", function(a) {
            this.a11yDirty && this.renderTo && (delete this.a11yDirty, this.updateA11yEnabled());
            var b = this.accessibility;
            b && b.getComponentOrder().forEach(function(a) { b.components[a].onChartRender() })
        });
        r(f.Chart, "update", function(a) {
        ...
        r(m, "update", function() { this.series.chart.accessibility && (this.series.chart.a11yDirty = !0) });
        ["addSeries", "init"].forEach(function(a) {
            r(f.Chart, a, function() {
                this.a11yDirty = !0
            })
        });
        ["update", "updatedData", "remove"].forEach(function(a) { r(f.Series, a, function() { this.chart.accessibility && (this.chart.a11yDirty = !0) }) });
        ["afterDrilldown", "drillupall"].forEach(function(a) { r(f.Chart, a, function() { this.accessibility && this.accessibility.update() }) });
        r(f.Chart, "destroy", function() { this.accessibility && this.accessibility.destroy() })
    });
