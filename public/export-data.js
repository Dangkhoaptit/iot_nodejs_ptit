...
*/
(function(c) { "object" === typeof module && module.exports ? (c["default"] = c, module.exports = c) : "function" === typeof define && define.amd ? define("highcharts/modules/export-data", ["highcharts", "highcharts/modules/exporting"], function(k) { c(k);
        c.Highcharts = k; return c }) : c("undefined" !== typeof Highcharts ? Highcharts : void 0) })(function(c) {
    function k(b, a, c, u) { b.hasOwnProperty(a) || (b[a] = u.apply(null, c)) }
    c = c ? c._modules : {};
    k(c, "mixins/ajax.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function(b, a) {
        var c = a.merge,
            u = a.objectEach;
        b.ajax = function(b) {
            var a = c(!0, { url: !1, type: "get", dataType: "json", success: !1, error: !1, data: !1, headers: {} }, b);
            ...
            u(a.headers, function(a, b) { d.setRequestHeader(b, a) });
            d.onreadystatechange = function() {
                if (4 === d.readyState) {
                    if (200 ===
                        d.status) { var b = d.responseText; if ("json" === a.dataType) try { b = JSON.parse(b) } catch (e) { a.error && a.error(d, e); return }
                        return a.success && a.success(b) }
                    a.error && a.error(d, d.responseText)
                }
            };
            try { a.data = JSON.stringify(a.data) } catch (A) {}
            d.send(a.data || !0)
        };
    ...
    k(c, "mixins/download-url.js", [c["parts/Globals.js"]], function(b) {
        ...
        b.dataURLtoBlob = function(b) { if ((b = b.match(/data:([^;]*)(;base64)?,([0-9A-Za-z+/]+)/)) && 3 < b.length && a.atob && a.ArrayBuffer && a.Uint8Array && a.Blob && k.createObjectURL) { var d = a.atob(b[3]),
                    c = new a.ArrayBuffer(d.length);
                c = new a.Uint8Array(c); for (var f = 0; f < c.length; ++f) c[f] = d.charCodeAt(f);
                b = new a.Blob([c], { type: b[1] }); return k.createObjectURL(b) } };
        b.downloadURL = function(d, k) {
            ...
            if ("string" === typeof d || d instanceof String || !c.msSaveOrOpenBlob) {
                ...
                else try { var f = a.open(d, "chart"); if ("undefined" === typeof f || null === f) throw Error("Failed to open window"); } catch (z) { a.location.href = d }
    ...
    k(c, "modules/export-data.src.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function(b, a) {
        function c(a, b) {
            ...
            try { if (c.msSaveOrOpenBlob && d.MSBlobBuilder) { var p = new d.MSBlobBuilder;
                    p.append(a); return p.getBlob("image/svg+xml") } if (!m) return e.createObjectURL(new d.Blob(["\ufeff" + a], { type: b })) } catch (G) {}
        }
        var k = a.defined,
            F = a.extend,
            v = a.pick,
        ...
        b.addEvent(b.Chart, "render", function() { this.options && this.options.exporting && this.options.exporting.showTable && !this.options.chart.forExport && this.viewData() });
        b.Chart.prototype.setUpKeyToAxis = function() { e.arearange && (e.arearange.prototype.keyToAxis = { low: "y", high: "y" });
        ...
        b.Chart.prototype.getDataRows = function(a) {
            var c = this.hasParallelCoordinates,
                ...
                B = [],
                w = [],
                r, C = function(h, c, d) { if (e.columnHeaderFormatter) { var g = e.columnHeaderFormatter(h, c, d); if (!1 !== g) return g } return h ? h instanceof b.Axis ? h.options.title && h.options.title.text || (h.isDatetimeAxis ? "DateTime" : "Category") : a ? { columnTitle: 1 < d ? c : h.name, topLevelColumnTitle: h.name } : h.name + (1 < d ? " (" + c + ")" : "") : "Category" },
                D = function(a, c, d) {
                    var h = {},
                        g = {};
            ...
            this.series.forEach(function(h) {
                ...
                if (!1 !== h.options.includeInDataExport && !h.options.isInternal && !1 !== h.visible) {
                    b.find(g, function(a) { return a[0] === k }) || g.push([k, y]);
                    for (n = 0; n < q;) r = C(h, t[n], t.length), w.push(r.columnTitle ||
                        r), a && B.push(r.topLevelColumnTitle || r), n++;
                    var x = { chart: h.chart, autoIncrement: h.autoIncrement, options: h.options, pointArrayMap: h.pointArrayMap };
            ...
            for (y = g.length; y--;) {
                ...
                var l = g[y][1];
                var x = m[t];
                f.sort(function(a, b) { return a.xValues[t] - b.xValues[t] });
                var E = C(x);
                q[0].splice(l, 0, E);
        ...
        b.Chart.prototype.getTable = function(a) {
            ...
            var f = 0,
                k = e ? a.shift() : null,
                m = a.shift(),
                w = function(a, b, c, e) { var g = v(e, "");
                    b = "text" + (b ? " " + b : ""); "number" === typeof g ? (g = g.toString(), "," === d && (g = g.replace(".", d)), b = "number") : e || (b = "empty"); return "<" + a + (c ? " " + c : "") + ' class="' + b + '">' + g + "</" + a + ">" };
            ...
            b += function(a, b, d) {
                ...
                d = d || b && b.length;
                var l, k = 0;
                if (l = e && a && b) { a: if (l = a.length, b.length === l) { for (; l--;)
                            if (a[l] !== b[l]) { l = !1; break a }
                        l = !0 } else l = !1;l = !l }
                if (l) {
                    for (f += "<tr>"; g <
                        d; ++g) { l = a[g]; var m = a[g + 1];
                ...
                if (b) { f += "<tr>";
                    g = 0; for (d = b.length; g < d; ++g) "undefined" !== typeof b[g] && (f += w("th", null, 'scope="col"', b[g]));
                    f += "</tr>" }
                return f + "</thead>"
        ...
        b.Chart.prototype.downloadCSV = function() { var a = this.getCSV(!0);
        ...
        b.Chart.prototype.viewData = function() { this.dataTableDiv || (this.dataTableDiv = A.createElement("div"), this.dataTableDiv.className = "highcharts-data-table", this.renderTo.parentNode.insertBefore(this.dataTableDiv, this.renderTo.nextSibling));
            this.dataTableDiv.innerHTML = this.getTable();
            z(this, "afterViewData", this.dataTableDiv) };
        if (a =
            b.getOptions().exporting) F(a.menuItemDefinitions, { downloadCSV: { textKey: "downloadCSV", onclick: function() { this.downloadCSV() } }, downloadXLS: { textKey: "downloadXLS", onclick: function() { this.downloadXLS() } }, viewData: { textKey: "viewData", onclick: function() { this.viewData() } } }), a.buttons && a.buttons.contextButton.menuItems.push("separator", "downloadCSV", "downloadXLS", "viewData");
